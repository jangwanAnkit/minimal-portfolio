...
Usage:
    ...
    python scripts/render_resume.py --template path/to/template.tex.j2 --output path/to/output.tex
"""
...
def main():
    ...
    parser.add_argument(
        "--template",
        default=str(DATA_DIR / TEMPLATE_FILE),
        help="Path to Jinja2 template file",
    )
    parser.add_argument(
        "--output",
        default=str(DATA_DIR / OUTPUT_FILE),
